...
the product of those three numbers,  and the third and fourth elements are strings that EXACTLY follow this
...
returns an array whose first element is the product of those numbers, and the second element is a
...
function multiplyArray(testArray){ //eslint-disable-line
  var total = 1; //eslint-disable-line
  for(var i = 0 ; i < testArray.length; i++){
    total = multiply(total ,testArray[i])[0];
  }
  var message = [total, 'The numbers 2,3,4 have a product of ' + total + '.'];
  return message;
}
